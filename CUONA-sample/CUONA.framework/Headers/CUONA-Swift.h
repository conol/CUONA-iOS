...
SWIFT_MODULE_NAMESPACE_PUSH("CUONA")
@class CUONASystemStatus;
enum CUONAOTAStatus : NSInteger;

SWIFT_PROTOCOL("_TtP5CUONA20CUONAManagerDelegate_")
...
SWIFT_CLASS("_TtC5CUONA17CUONASystemStatus")
@interface CUONASystemStatus : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end

typedef SWIFT_ENUM(NSInteger, CUONAType) {
  CUONATypeUnknown = 0,
  CUONATypeCuona = 1,
  CUONATypeSeal = 2,
};
...
SWIFT_PROTOCOL("_TtP5CUONA21DeviceManagerDelegate_")
...
SWIFT_CLASS("_TtC5CUONA5Cuona") SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface Cuona : NSObject <CUONAManagerDelegate, DeviceManagerDelegate>
- (BOOL)cuonaNFCDetectedWithDeviceId:(NSString * _Nonnull)deviceId type:(NSInteger)type json:(NSString * _Nonnull)json SWIFT_WARN_UNUSED_RESULT;
- (void)cuonaNFCCanceled;
- (void)cuonaIllegalNFCDetected;
- (void)cuonaUpdatedJSON;
...
SWIFT_PROTOCOL("_TtP5CUONA13CuonaDelegate_")
@protocol CuonaDelegate
...
SWIFT_PROTOCOL("_TtP5CUONA19HttpRequestDelegate_")
